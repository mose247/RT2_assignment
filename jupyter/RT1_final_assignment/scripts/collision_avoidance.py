...
.. module:: collision_avoidance
    :platform: Unix
    :synopsis: Python module for implementing a collision avoidance system

.. moduleauthor:: Luca Mosetti

This module implements a controller that update the robot's velocity in order to
avoid crashing into obstacles inside the map.
...
def scan_callback(msg):
    ...
    :param msg: contains the ranges returned by the sensor;
    :type msg: LaserScan message
    :return: none;
    """
    regions = {
...
def avoid_collision(regions):
    ...
    :param regions: contains the minimum distances in 5 direction;
    :type regions: dictionary direction:value
    :return: none;
    """
    global astd_vel
...
def main():
    """
    This function initializes the ROS node.
    """
    # initialize the node
