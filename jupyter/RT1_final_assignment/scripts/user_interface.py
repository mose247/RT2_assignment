...
.. moduleauthor:: Luca Mosetti

This module implements an user interface to allow the user to select the desired
driving mode.
...
def auto_vel_callback(msg):
    """
    Callback function that is called each time that a new message on the "/automatic/cmd_vel"
    ...
    :param msg: contains the velocity generated by the "move_base" node;
    :type msg: Twist message;
    :return: none;
    """
    global mode_cmd, pub
...
def man_vel_callback(msg):
    """
    Callback function that is called each time that a new message on the "/manual/cmd_vel"
    topic is published. The function is used to published it on the "/cmd_vel" topic
    when the user has selected the corresponding mode.

    :param msg: contains the velocity generated by the "teleop_twist_keyboard" node;
    :type msg: Twist message;
    :return: none;
    """
    global mode_cmd, pub
...
def astd_vel_callback(msg):
    """
    Callback function that is called each time that a new message on the "/assisted/cmd_vel"
    topic is published. The function is used to published it on the "/cmd_vel" topic
    when the user has selected the corresponding mode.

    :param msg: contains the velocity generated by the "collision_avoidance" node;
    :type msg: Twist message;
    :return: none;
    """
    global mode_cmd, pub
...
def get_goal():
    ...
    :parameters: none;
    :return: a tuple (x, y) containing the coordinates of the point to reach;
    """
...
def main():
    """
    This function initializes the ROS node and diplays an interface to allow the
    user to select the desired driving mode.
    """
    # initialize the node
